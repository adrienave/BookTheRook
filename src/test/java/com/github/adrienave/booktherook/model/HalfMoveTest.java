...
class HalfMoveTest {
    ...
    @Test
    public void second_square_does_not_have_same_file_when_move_is_to_another_file() {
    ...
    @Test
    public void second_square_does_not_have_same_rank_when_move_is_to_another_rank() {
    ...
    @Test
    public void squares_are_boundaries_when_move_is_one_corner_to_another_one() {
    ...
    @Test
    public void is_king_side_castle_only_when_algebraic_move_is_O_dash_O() {
    ...
    @Test
    public void is_queen_side_castle_only_when_algebraic_move_is_O_dash_O_dash_O() {
    ...
    @Test
    public void is_not_castle_when_algebraic_move_is_not_proper_castle() {
    ...
    @Test
    public void is_capture_when_algebraic_move_contains_x() {
    ...
    @Test
    public void is_not_capture_when_algebraic_move_does_not_contain_x() {
        HalfMove move = HalfMove.builder().algebraicNotation("c4").build();
